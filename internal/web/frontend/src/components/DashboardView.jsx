              ...
              <thead>
                <tr className="border-b border-white/[0.06]">
                  {['Date', 'Conteneur', 'Image / digest', 'Statut', 'Détails', 'CVEs (C/H/M)'].map(h => (
                    <th key={h} className="px-4 py-3 text-left font-mono text-[10px] font-medium text-[#94A3B8]/60 uppercase tracking-widest">
                      {h}
                    </th>
                  ))}
                </tr>
                ...
                {auditLogs.length === 0 ? (
                  ...
                  auditLogs.map(log => (
                    <tr key={log.id} className="border-b border-white/[0.03] hover:bg-white/[0.02] transition-colors">
                      ...
                      <td className={cn('px-4 py-3 font-mono font-bold text-[10px] tracking-wider', logStatusStyle(log.status))}>
