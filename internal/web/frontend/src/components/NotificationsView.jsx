                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-3 mb-1">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      <span className="font-mono text-[10px] text-[#94A3B8]/40 whitespace-nowrap">{n.time}</span>
                    </div>
                  </div>
                  <p className="text-xs text-[#94A3B8] mb-2 leading-relaxed">{n.desc}</p>
                  <div className="flex items-center gap-1.5 font-mono text-[11px] text-[#94A3B8]/50">
